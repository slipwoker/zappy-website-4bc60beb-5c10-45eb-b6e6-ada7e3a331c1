document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleSmoothScroll(e) {
        ...
        if (isRTL) {
            ...
            const scrollLeft = targetRect.left + window.pageXOffset - (window.innerWidth - document.documentElement.clientWidth);
            window.scrollTo({
                left: scrollLeft,
                behavior: 'smooth'
            });
    ...
    function handleFormSubmit(e) {
        ...
        fetch(action, options)
            ...
            .then(data => {
                ...
                if (submitButton) {
                    submitButton.textContent = submitButton.getAttribute('data-success-text') || 'Sent!';
                    setTimeout(() => {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('change', handleFormInput);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4bc60beb-5c10-45eb-b6e6-ada7e3a331c1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4bc60beb-5c10-45eb-b6e6-ada7e3a331c1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4bc60beb-5c10-45eb-b6e6-ada7e3a331c1';
